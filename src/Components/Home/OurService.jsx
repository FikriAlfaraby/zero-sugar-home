...
const OurService = () => {
  ...
  return (
    <section id="services" className="w-full px-6 md:px-12 py-[40px] relative">
      <h1 className="text-[25px] md:text-[40px] font-[700] leading-[60px] mb-[40px]">
        Our Services
      </h1>
              ...
              <SwiperSlide key={index}>
                <div className="w-full rounded-[12px] bg-[#FBFBFB] cursor-pointer">
                  ...
                  <div className="p-[15px]">
                    <h1 className="text-[24px] leading-[36px] font-[600] mb-[10px] text-left">
                      {service.title}
                    </h1>
                    <p className="text-[16px] font-[400] leading-[24px] text-[#585858] text-left">
                      {service.description}
                    </p>
                  </div>
                </div>
